								...
								<tr>
									...
									<td >
										...
										<c:if test="${dto.ref_level > 1}"><!-- 들여쓰기 > 1 -->
											...
											<img src="${projectboard}boardimages/level.gif" border="0" width="${wid} height="15">
										</c:if>
										
										<!-- 들여쓰기 > 0 : 답변글 -->
										<c:if test="${dto.ref_level > 0}">
											<img src="${projectboard}boardimages/re.gif" border="0" width="20" height="15">
										</c:if>
										...
										<c:if test="${dto.readCnt > 10}">
											<img src="${projectboard}boardimages/hot.gif" border="0" width="20" height="15">
										</c:if>
									</td>
